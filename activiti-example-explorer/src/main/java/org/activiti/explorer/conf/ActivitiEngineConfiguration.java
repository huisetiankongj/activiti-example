...
public class ActivitiEngineConfiguration
{
  ...
  @Bean
  public DataSource dataSource() { SimpleDriverDataSource ds = new SimpleDriverDataSource();
    try
    {
  ...
  {
    try {
      return processEngineFactoryBean().getObject(); } catch (Exception e) {
  ...
  public ProcessEngineConfigurationImpl processEngineConfiguration() {
    ...
    processEngineConfiguration.setJobExecutorActivate(Boolean.valueOf(this.environment
      .getProperty("engine.activate.jobexecutor", "false")).booleanValue());

    processEngineConfiguration.setAsyncExecutorEnabled(Boolean.valueOf(this.environment
      .getProperty("engine.asyncexecutor.enabled", "true")).booleanValue());

    processEngineConfiguration.setAsyncExecutorActivate(Boolean.valueOf(this.environment
      .getProperty("engine.asyncexecutor.activate", "true")).booleanValue());
