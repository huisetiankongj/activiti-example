...
public class DemoDataConfiguration
{
  ...
  protected void initDemoGroups()
  {
    ...
    String[] arrayOfString1 = assignmentGroups; int i = arrayOfString1.length; for (int str1 = 0; str1 < i; str1++) { String groupId = arrayOfString1[str1];
      createGroup(groupId, "assignment");
    }

    String[] securityGroups = { "user", "admin" };
    String[] arrayOfString2 = securityGroups; int str1 = arrayOfString2.length; for (int groupId = 0; groupId < str1; groupId++) { String s = arrayOfString2[groupId];
      createGroup(s, "security-role"); }
  }
  ...
  protected void initDemoUsers() {
    ...
    createUser("gonzo", "Gonzo", "The Great", "gonzo", "gonzo@activiti.org", "org/activiti/explorer/images/gonzo.jpg", 
      Arrays.asList(new String[] { "management", "sales", "marketing", "user" }), 
      null);

    createUser("fozzie", "Fozzie", "Bear", "fozzie", "fozzie@activiti.org", "org/activiti/explorer/images/fozzie.jpg", 
      Arrays.asList(new String[] { "marketing", "engineering", "user" }), 
      null);
  }
  ...
  protected void generateReportData()
  {
    Thread thread = new Thread(new Runnable()
    {
      public void run()
      {
        ...
        List jobs = DemoDataConfiguration.this.managementService.createJobQuery().list();
        ...
        while (!tasks.isEmpty()) {
          for (Task task : tasks)
          {
            ...
            DemoDataConfiguration.this.processEngineConfiguration.getClock().setCurrentTime(
              new Date(task
